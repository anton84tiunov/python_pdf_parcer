...
class ExtractElFromPdf():
    ...
    def ex_image(self, doc: fitz.Document, page: fitz.Page) -> list:
        ...
        for image_index, img in enumerate(image_list, start=1):
            ...
            # print(base_image.keys())
            # print("ext", type(base_image["ext"]))
            # print("smask", type(base_image["smask"]))
            # print("width", type(base_image["width"]))
            # print("height", type(base_image["height"]))
            # print("colorspace", type(base_image["colorspace"]))
            # print("bpc", type(base_image["bpc"]))
            # print("xres", type(base_image["xres"]))
            # print("yres", type(base_image["yres"]))
            # print("cs-name", type(base_image["cs-name"]))
