...
class MyDemoHighlightRactangle(QtWidgets.QGraphicsRectItem):
    ...
    def __init__(self, rect: QtCore.QRectF):
        ...
        self.setBrush(QtGui.QColor.fromRgbF(0.1, 0.5, 0.2, 0.2))
        pen = QtGui.QPen()
        pen.setColor(QtGui.QColor.fromRgbF(0.5, 0.5, 0.5, 1.0 ))
        pen.setWidthF(1.5)
