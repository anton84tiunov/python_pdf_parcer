...
class MyDialogPropEll(QtWidgets.QDialog, my_dialog_settings_graph.Ui_dialog_settins_el):
    ...
    def __init__(self, root: QtWidgets, pen: QtGui.QPen, brush: QtGui.QBrush, item_z_index: float, item_opacity: float, **kwargs):
        ...
        self.item_ell = QtWidgets.QGraphicsEllipseItem(self.rect)
        ...
        self.item_ell.setPen(pen)
        self.item_ell.setBrush(brush)
        self.scene_priview.addItem(self.item_ell)
    ...
    def set_default(self):
        ...
        config.update_setting(conf_path, "ellipse", "pen_color",str( self.pen_color.getRgb()))
        config.update_setting(conf_path, "ellipse", "pen_width",str( self.pen_width))
        config.update_setting(conf_path, "ellipse", "pen_style",str( self.pen_sryle).replace("PenStyle.", ""))
        config.update_setting(conf_path, "ellipse", "pen_cap_style",str( self.pen_cap_style).replace("PenCapStyle.", ""))
        config.update_setting(conf_path, "ellipse", "pen_join_style",str( self.pen_join_style).replace("PenJoinStyle.", ""))
        config.update_setting(conf_path, "ellipse", "pen_dash_offset",str( self.dash_offset))
        config.update_setting(conf_path, "ellipse", "pen_dash_pattern",str( self.dash_pattern))
        config.update_setting(conf_path, "ellipse", "brush_style",str( self.brush_style).replace("BrushStyle.", ""))
        config.update_setting(conf_path, "ellipse", "brush_color",str( self.brush_color.getRgb()))
        # print(conf.sections())
    def get_value(self):
    ...
    def get_brush_color(self):
        ...
        # print(type(color.getRgb()), color.getRgb())
        self.btn_brush_color.setStyleSheet(f"background-color:{self.brush_color.name()}")
        self.item_ell.setBrush(self.brush)
