...
class MyDialogPropRect(QtWidgets.QDialog, my_dialog_settings_graph.Ui_dialog_settins_el):
    ...
    def __init__(self, root: QtWidgets, pen: QtGui.QPen, brush: QtGui.QBrush, item_z_index: float, item_opacity: float, **kwargs):
        ...
        self.rect.setTopLeft(QtCore.QPointF(10.0, 10.0))
        self.rect.setBottomRight(QtCore.QPointF(140.0, 140.0))
        self.item_rect = QtWidgets.QGraphicsRectItem(self.rect)
        ...
        # self.item_pol = QtWidgets.QGraphicsPathItem(self.path)
        self.item_rect.setPen(pen)
        self.item_rect.setBrush(brush)
        self.scene_priview.addItem(self.item_rect)
    ...
    def set_default(self):
        ...
        config.update_setting(conf_rect, "rectangle", "pen_color",str( self.pen_color.getRgb()))
        config.update_setting(conf_rect, "rectangle", "pen_width",str( self.pen_width))
        config.update_setting(conf_rect, "rectangle", "pen_style",str( self.pen_sryle).replace("PenStyle.", ""))
        config.update_setting(conf_rect, "rectangle", "pen_cap_style",str( self.pen_cap_style).replace("PenCapStyle.", ""))
        config.update_setting(conf_rect, "rectangle", "pen_join_style",str( self.pen_join_style).replace("PenJoinStyle.", ""))
        config.update_setting(conf_rect, "rectangle", "pen_dash_offset",str( self.dash_offset))
        config.update_setting(conf_rect, "rectangle", "pen_dash_pattern",str( self.dash_pattern))
        config.update_setting(conf_rect, "rectangle", "brush_style",str( self.brush_style).replace("BrushStyle.", ""))
        config.update_setting(conf_rect, "rectangle", "brush_color",str( self.brush_color.getRgb()))
        # print(conf.sections())
    ...
    def get_pen_color(self):
        ...
        self.btn_pen_color.setStyleSheet(f"background-color: {self.pen_color.name()}")
        self.item_rect.setPen(self.pen)
    ...
    def get_brush_color(self):
        ...
        # print(type(color.getRgb()), color.getRgb())
        self.btn_brush_color.setStyleSheet(f"background-color:{self.brush_color.name()}")
        self.item_rect.setBrush(self.brush)
